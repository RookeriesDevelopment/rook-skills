...
Put **1–3 runnable, copy-paste golden-path snippets** here that take a developer from zero to a first
successful sync.
...
Delete this `README.md` once you've added the real snippets.
