...
**Skill:** `rook-flutter-samsung-health` · **Author:** ROOK
...
```bash
npx skills add RookeriesDevelopment/rook-skills --skill rook-flutter-samsung-health
```

Target a specific agent and skip prompts:

```bash
npx skills add RookeriesDevelopment/rook-skills --skill rook-flutter-samsung-health -a claude-code -y
```
...
# Claude / Claude Code:
cp -r rook-skills/skills/rook-flutter-samsung-health .claude/skills/

# Codex / Antigravity / Cursor:
cp -r rook-skills/skills/rook-flutter-samsung-health .agents/skills/
```
