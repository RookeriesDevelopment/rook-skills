...
**Skill:** `rook-flutter-health-connect` · **Author:** ROOK
...
```bash
npx skills add RookeriesDevelopment/rook-skills --skill rook-flutter-health-connect
```

Target a specific agent and skip prompts:

```bash
npx skills add RookeriesDevelopment/rook-skills --skill rook-flutter-health-connect -a claude-code -y
```
...
# Claude / Claude Code:
cp -r rook-skills/skills/rook-flutter-health-connect .claude/skills/

# Codex / Antigravity / Cursor:
cp -r rook-skills/skills/rook-flutter-health-connect .agents/skills/
```
