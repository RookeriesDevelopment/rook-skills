...
**Skill:** `rook-android-samsung-health` · **Author:** ROOK
...
```bash
npx skills add RookeriesDevelopment/rook-skills --skill rook-android-samsung-health
```

Target a specific agent and skip prompts:

```bash
npx skills add RookeriesDevelopment/rook-skills --skill rook-android-samsung-health -a claude-code -y
```
...
# Claude / Claude Code:
cp -r rook-skills/skills/rook-android-samsung-health .claude/skills/

# Codex / Antigravity / Cursor:
cp -r rook-skills/skills/rook-android-samsung-health .agents/skills/
```
