...
**Skill:** `rook-flutter-apple-health` · **Author:** ROOK
...
```bash
npx skills add RookeriesDevelopment/rook-skills --skill rook-flutter-apple-health
```

Target a specific agent and skip prompts:

```bash
npx skills add RookeriesDevelopment/rook-skills --skill rook-flutter-apple-health -a claude-code -y
```
...
# Claude / Claude Code:
cp -r rook-skills/skills/rook-flutter-apple-health .claude/skills/

# Codex / Antigravity / Cursor:
cp -r rook-skills/skills/rook-flutter-apple-health .agents/skills/
```
